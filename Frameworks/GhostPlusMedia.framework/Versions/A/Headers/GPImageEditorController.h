...
@protocol GPImageEditorControllerDelegate;


/**
 이미지 편집 뷰컨트롤러
 */
@interface GPImageEditorController : UIViewController
<
...
/** 델리게이트 */
@property (nonatomic, weak) id<GPImageEditorControllerDelegate> delegate;
...
/**
 이미지 편집 뷰컨트롤러 델리게이트
 */
@protocol GPImageEditorControllerDelegate <NSObject>
@required
/**
 이미지 편집 완료시
 @param image 편집된 이미지
 */
- (void)GPImageEditorController:(GPImageEditorController *)imageEditorViewController didFinishEditingImage:(UIImage *)image;
/**
 이미지 편집 취소시
 */
- (void)GPImageEditorControllerDidCancel:(GPImageEditorController *)imageEditorViewController;
@end